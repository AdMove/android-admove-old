...
public class CognitoSyncClientManager {
    ...
    private static final String IDENTITY_POOL_ID = "us-east-1:1819e837-0832-4192-a44a-7a9df4b29bb0";
     ...
     */
    @SuppressLint("LongLogTag") // TODO: Something should be done with this fucking lint!
